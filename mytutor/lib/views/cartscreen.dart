...
import 'package:mytutor/model/cart.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('My Tutor - My Cart'),
  ...
  void _loadCart() {
    http.post(Uri.parse(CONSTANTS.server + "/276984/mytutor/php/load_cart.php"),
        body: {
      ...
      if (response.statusCode == 200 && jsondata['status'] == 'success') {
        ...
        if (extractdata['cart'] != null) {
          ...
          for (var element in cartList) {
            ...
            totalpayable =
                totalpayable + double.parse(element.subPrice.toString());
          }
          titlecenter = qty.toString() + " courses in your cart";
          setState(() {});
        }
      } else {
  ...
  void _updateCart(int index, String s) {
    ...
    http.post(
        Uri.parse(CONSTANTS.server + "/276984/mytutor/php/update_cart.php"),
  ...
  void _deleteItem(int index) {
    http.post(
        Uri.parse(CONSTANTS.server + "/276984/mytutor/php/delete_cart.php"),
        body: {
